      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0b1326] relative flex-col justify-between p-12 overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 text-left">
          <div className="flex items-center gap-3 mb-8 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-2xl font-bold tracking-tight text-white">SyncStream</span>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-[#060e20] relative">
        ...
        <div className="w-full max-w-md glass-panel p-8 sm:p-10 rounded-2xl relative z-10 shadow-2xl text-left">
          ...
          <div className="space-y-3 mb-6">
            <button 
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-[#1b2336] hover:bg-[#252d41] border border-white/5 transition-colors text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#6d28d9]/50"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-[#818cf8] hover:text-[#a78bfa] transition-colors">Forgot password?</Link>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 rounded-xl bg-[#1b2336] border border-white/5 flex items-start gap-3">
            ...
            <p className="text-sm text-[#94a3b8]">
              We never share your data with third parties. Read our <a className="text-[#818cf8] hover:underline" href="#privacy">Privacy Policy</a> to learn more.
            </p>
          </div>
